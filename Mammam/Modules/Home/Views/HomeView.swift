...
struct ProfileView: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            // Menu Items
            VStack(spacing: 0) {
                menuItem(icon: "pencil", title: "Update Baby Profile", action: {})
                
                menuItem(icon: "exclamationmark.triangle", title: "Food Restriction", trailing: "3 restrictions", action: {})
                
                menuItem(icon: "rectangle.portrait.and.arrow.right", title: "Log Out", action: {})
                    .foregroundColor(.red)
            }
            ...
            // Tab Bar
            HStack {
                tabItem(icon: "house", text: "Home", isSelected: false)
                tabItem(icon: "fork.knife", text: "Meal Planner", isSelected: false)
                tabItem(icon: "chart.bar", text: "Progress", isSelected: false)
                tabItem(icon: "person.fill", text: "Profile", isSelected: true)
            }
    ...
    private func menuItem(icon: String, title: String, trailing: String? = nil, action: @escaping () -> Void) -> some View {
    ...
    private func tabItem(icon: String, text: String, isSelected: Bool) -> some View {
        VStack(spacing: 4) {
            Image(systemName: icon)
            Text(text)
                .font(.caption)
